...
const Whatsapp = () => {
  ...
  let handleInputChange = (e) => {
    let mensagemValue = e.target.value
    setMensagem(mensagemValue);
  }
  ...
  function openUrl({ mensagem }) {
    //const tel = 5561991108778
    
    return ('https://api.whatsapp.com/send?phone=' + tel + '&text=' + mensagem)
  }
  ...
  const handleSubmit = () => {
    ...
    setMensagem('');
    setTimeout(() => {
      location.href = 'https://api.whatsapp.com/send?phone=' + tel + '&text=' + mensagem
    }, 2000)
  }

  const nomeContato = "Corpus - Fisioterapia & Pilates"
